...
def get_para(view, like, comment,  positive_videos, negative_videos):
    """
    :param positive_videos:
    :param negative_videos:
    ...
    """
    return (positive_videos - negative_videos) * (like * comment) / view
...
#              Type: np.array
#     """
#     title, category, tags, description, duration = kent.get_feature(csv_path)
...
#     return glove_title, category, glove_tags, glove_description, duration
#
# def separa_test(csv):
#     """
