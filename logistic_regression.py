...
model = LogisticRegression(multi_class='multinomial', penalty='l1', max_iter=5000, solver='saga')
...
results = confusion_matrix(y_test,y_pred_score)
print(results)

accuracy = accuracy_score(y_test,y_pred_score) * 100
print(accuracy)
