...
import collections
# read Data
file_path = 'Dataset/finalVideos.csv'
youTube_Data = pd.read_csv(file_path, encoding='unicode_escape')

#Initial Boundary
view_bar, para_bar = 10000, [0, 186]
...
# Assign Scoring
train_label = kent.get_label('Dataset/finalVideos.csv', view_bar, para_bar)
youTube_Data['score'] = train_label
print(youTube_Data['category'].unique())
print(youTube_Data['score'].value_counts()[0])
print(youTube_Data['score'].value_counts()[1])
print(youTube_Data['score'].value_counts()[2])
print(youTube_Data['score'].value_counts()[3])

#youTube_Data.to_csv("Dataset/test.csv")
#train_title, train_category, train_tags, train_description, train_duration = zlq.word_embedding('finalVideos.csv', dictionary)
# Splitting the dataset



# # Training Set
# train_label = kent.get_label('finalVideos.csv', view_bar, para_bar)
# train_title, train_category, train_tags, train_description, train_duration = zlq.word_embedding('finalVideos.csv', dictionary)
#
#
# # Valid Set
# valid_label = kent.get_label('valid_set_with_time.csv', view_bar, para_bar)
# valid_title, valid_category, valid_tags, valid_description, valid_duration = zlq.word_embedding('valid_set_with_time.csv', dictionary)
#
# #Test Set
...
#
#
# train = np.hstack((train_title, train_category, train_tags, train_description, train_duration))
#
# valid = np.hstack((valid_title, valid_category, valid_tags, valid_description, valid_duration))
#
